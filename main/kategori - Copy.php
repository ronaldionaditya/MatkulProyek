...
<html lang="en">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Modal Headings</h4>
       ...
       <!-- <form method="post">
            <div class="modal-body">
                ...
                <input type="text" name="nama_kategori" placeholder="Nama Kategory" class="form-control">
                <input type="text" name="deskripsi_kategori" placeholder="Deskripsi" class="form-control">
        ...
        <form method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="deskripsi_kategori" class="form-control">
            </div>
            <div class="input-group mb-3">
